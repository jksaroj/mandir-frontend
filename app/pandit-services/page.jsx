    ...
    <main className="min-h-screen bg-[#fffaf5] text-[#1f2937]">
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <WaveGrid className="grid gap-5 rounded-2xl border border-[#f1e4d6] bg-white p-6 shadow-sm sm:grid-cols-2 lg:grid-cols-4">
          {stats.map(([value, label]) => <WaveGridItem key={label} className="text-center"><p className="text-3xl font-extrabold text-[#6b2323]"><CountUp value={value} /></p><p className="mt-1 text-sm font-bold text-slate-600">{label}</p></WaveGridItem>)}
        </WaveGrid>
      </section>
