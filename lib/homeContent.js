...
export const homeFaqItems = [
  ...
  },
  {
    ...
    content:
      "Hanuman Chalisa is a 40-verse devotional hymn composed by Goswami Tulsidas in praise of Lord Hanuman. Chanting it is believed to remove obstacles, grant courage, and deepen devotion. Read the full chalisa with meaning on brahmatatva."
  },
  {
...
homeFaqItems.push({
  title: "How can I plan a temple visit using BrahmaTatva?",
  content: "Check the temple guide for darshan timings, history, location, facilities and travel information. Confirm special festival timings with the temple authority before travelling."
});
